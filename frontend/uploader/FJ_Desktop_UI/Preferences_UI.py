...
class Ui_DialogPreferences(object):
    def setupUi(self, DialogPreferences):
        ...
        self.buttonBoxPreferences.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBoxPreferences.setObjectName(_fromUtf8("buttonBoxPreferences"))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.listWidgetPreferences.sizePolicy().hasHeightForWidth())
        ...
        self.listWidgetPreferences.setObjectName(_fromUtf8("listWidgetPreferences"))
        ...
        QtCore.QObject.connect(self.buttonBoxPreferences, QtCore.SIGNAL(_fromUtf8("accepted()")), DialogPreferences.accept)
        QtCore.QObject.connect(self.buttonBoxPreferences, QtCore.SIGNAL(_fromUtf8("rejected()")), DialogPreferences.reject)
