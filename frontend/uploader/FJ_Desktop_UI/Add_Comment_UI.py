...
class Ui_DialogAddComment(object):
    def setupUi(self, DialogAddComment):
        ...
        sizePolicy.setHeightForWidth(DialogAddComment.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.plainTextEditAddComment.sizePolicy().hasHeightForWidth())
        self.plainTextEditAddComment.setSizePolicy(sizePolicy)
        self.plainTextEditAddComment.setObjectName(_fromUtf8("plainTextEditAddComment"))
        ...
        self.buttonBoxAddComment.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBoxAddComment.setObjectName(_fromUtf8("buttonBoxAddComment"))
        self.verticalLayout.addWidget(self.buttonBoxAddComment)

        self.retranslateUi(DialogAddComment)
        QtCore.QObject.connect(self.buttonBoxAddComment, QtCore.SIGNAL(_fromUtf8("accepted()")), DialogAddComment.accept)
        QtCore.QObject.connect(self.buttonBoxAddComment, QtCore.SIGNAL(_fromUtf8("rejected()")), DialogAddComment.reject)
        QtCore.QMetaObject.connectSlotsByName(DialogAddComment)

    def retranslateUi(self, DialogAddComment):
        DialogAddComment.setWindowTitle(_translate("DialogAddComment", "Add Comment", None))
