...
class TestTimestamp(unittest.TestCase):
    ...
    def test_check(self):
        ...
        self.assertEqual(value['Transaction'], "2be396b3c08c71c04e750142eda9216f52cdd4277345a239ec736fe2540f5e53")
        return 0

    def test_check_collection1(self):
        test_obj = TimestampFile("f61504ae086c136511e7982c5d638a155c8a88832cd35c35c32f7de23ca5ce54") #echo -n test_collection | sha256sum
        value = test_obj.check_timestamp()
        self.assertTrue(value['timestamp'])
        self.assertEqual(value['time'], "2015-03-16 02:19:19")
        self.assertEqual(value['Transaction'], "c6788150e4a409c653f7244da3ebfef3fa7cfb5faf87d3e31fd997d42bdfde7b")
        return 0
