...
class Cache():
    ...
    def get_documents_from_collection(self, collection_address):
        """Retrieve Documents by collection bitmessage address
          :param collection_address: The collection bimessage address to retreive
          :return: the Documents with the collection"""
    ...
    def get_versions_for_collection(self, collection_address):
        """Get collection version by collection bitmessage address
          :param collection_address: collection bitmessage address
          :return: the version number of the collection """
