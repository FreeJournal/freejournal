...
def check_config_creation():
    ...
    return os.path.exists(
        os.path.expanduser("~/.config/PyBitmessage/keys.dat")
    )
...
def apt_install():
    ...
    try:
        ...
        print(
            'PyBitmessage already installed or permission denied error'
        )
    ...
    shutil.copyfile(
        ...
        "/installfiles/keys.dat", os.path.expanduser(
...
def windows_install():
    print (
        'FATAL ERROR: We detected you are using an ' +
        'inferior operating system to Linux...'
    )
